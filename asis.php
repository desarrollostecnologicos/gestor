		...
		<h1 class="w3l-inner-h-title">ASIS</h1>
			...
			foreach ($archivos1 as $i => $archivo) {
				...
				if ($archivo != '.' && $archivo != '..' && $archivo != '~$'){
					...
					echo '<div class="price-grid"><div class="price-block agile"><div class="price-gd-top pric-clr1"><i class="fa fa-slideshare" aria-hidden="true"></i><h4>PPT</h4><p>'.$nombre.'</p>';
