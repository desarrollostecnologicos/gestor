...
<div class="plans-section">
	<div class="plans-main">
		<h1 class="w3l-inner-h-title">Sala de Situacion</h1>
					...
					<div class="price-block agile">
						<div class="price-gd-top pric-clr1">
							...
							<div class="price-selet pric-sclr1">		    			   
								<a href="./asis.php" class="w3_agileits_sign_up2" >Acceder</a>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="price-block price-block1 agile">
						<div class="price-gd-top pric-clr2">
							...
							<div class="price-selet pric-sclr2">
								<a href="#small-dialog" class="w3_agileits_sign_up2 popup-with-zoom-anim ab scroll" >Acceder</a>
